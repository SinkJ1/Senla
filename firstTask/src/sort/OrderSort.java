...
public class OrderSort {
	...
	public List<Order> dateOfApplication(List<Order> listorder) {
		listorder.sort(Comparator.comparing(Order::getDateOfApplication));
		return listorder;
	}

	public List<Order> dateOfCompletion(List<Order> listorder) {
		listorder.sort(Comparator.comparing(Order::getDateOfCompletion));
		return listorder;
	}

	public List<Order> dateOfPlannedStartOfExecution(List<Order> listorder) {
		listorder.sort(Comparator.comparing(Order::getDateOfPlannedStartOfExecution));
		return listorder;
	}

	public List<Order> cost(List<Order> listorder) {
